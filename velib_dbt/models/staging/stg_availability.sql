...
flattened as (
    select
        ...
        f.value:is_installed::string = 'OUI'        as is_installed,
        f.value:is_renting::string = 'OUI'          as is_renting,
        f.value:is_returning::string = 'OUI'        as is_returning,
    ...
    where f.value:stationcode::varchar is not null
      and f.value:numbikesavailable::int is not null
)
